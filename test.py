...
#     print(f"_cutoff: {cutoff}")
#     with MailBox(IMAP_HOST).login(IMAP_USER, IMAP_PASS) as mailbox:

#         for msg in mailbox.fetch('(FROM "mailer-daemon@googlemail.com")', limit=20):
#             print(f"📧 Checking email from: {msg.from_},\n subject: {msg.subject},\n date: {msg.date}")
...
#     return bounced
    ...
    #         # 🎯 bounce detection using content
    #         is_bounce = any(
